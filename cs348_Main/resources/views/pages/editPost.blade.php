                    ...
                    <div @class=" flex justify-center component('components/post-form')">
                        <div class="postForm">
                            ...
                            <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" method="POST"
                                ...
                                <div class="mt-2">
                                   <textarea
                                       class="resize:none bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-10 font-medium placeholder-gray-700 focus:outline-none focus:bg-white "
                                       name="title"
