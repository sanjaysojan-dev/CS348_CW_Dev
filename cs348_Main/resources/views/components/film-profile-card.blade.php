            ...
            <div class="px-4 pt-4">
                <form action="#" class="flex flex-col space-y-8">
                    ...
                    <div class="form-item w-full">
                        ...
                        <textarea cols="30" rows="5" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25 " ></textarea>
                    </div>
